...
class TestLogoutView:
    def test_logout_view_url(self):
        path = reverse("user_management:logout")
    ...
    def test_user_logout(self, client):
        ...
        response = client.get(reverse("user_management:profile"))
    ...
    def test_logout_redirects_to_home(self, client):
        ...
        assert response.url == reverse("home:home_page")  # Assumes redirect to 'home'
    ...
    def test_logout_clears_session(self, client):
        ...
        # Act: Log out
        client.get(reverse("user_management:logout"))
