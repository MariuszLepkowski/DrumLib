...
class TestProfileView:
    def test_profile_view_accessible_for_logged_in_user(self, client, django_user_model):
        """
        ...
        assert 'user_management_app/profile.html' in [t.name for t in response.templates]
